...
namespace ProjectProduk
{
    class Program
    {
        ...
        static void TambahProduk()
        {
            ...
            produk.kd_produk = Console.ReadLine();
        ...
        static void TampilProduk()
        {
            ...
            {
                noUrut++;
                Console.WriteLine("{0}. {1}, {2}, {3:N0}, {4:N0}", noUrut, produk.kd_produk, produk.nama_produk, produk.harga_beli, produk.harga_jual);
            }
            if (noUrut < 1)
            {
